...
function Dashboard() {
  return (
    <div className="relative ">
      ...
      {/* Foreground (cards) */}
      <div className="relative z-10 flex p-4 lg:p-[5rem] justify-between flex-col md:flex-row gap-4">
        {DashboardPageItemsData.map((item, index) => (
          <Card
            className={`w-full h-64 md:w-1/3 transition-all duration-200 hover:-translate-y-0.5 ${item.color}`}
            key={index}
          >
            <CardHeader>
