...
function Hero() {
  return (
    <section className="flex mt-2 sm:mt-10   lg:pt-44  lg:flex-row items-center justify-between gap-10 sm:px-6 md:px-16  mb-10">
      {/* Text content */}
      <div className="w-2/3 md:text-center md:w-2/5  lg:text-left">
        ...
        <div>
          <Button className="text-green-700 border-2 mt-2 h-10 font-semibold md:mt-4 border-green-700 hover:text-white cursor-pointer bg-white">
            Let&apos;s Talk
          </Button>
        </div>
      </div>
      ...
      {/* Image */}
      <div className=" sm:flex-1/2 block relative h-[230px]  w-[300px] md:h-[300px]">
        <Image
